...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget buildPages() {
    return PageView(
      ...
      children: [
        onboardPageView(
          const AssetImage('assets/app_assets/recommend.png'),
          '''Checkout weekly recommended recipes and what your friends are cooking!''',
        ),
        onboardPageView(const AssetImage('assets/app_assets/sheet.png'),
            'Cook with step by step instructions!'),
        onboardPageView(const AssetImage('assets/app_assets/list.png'),
